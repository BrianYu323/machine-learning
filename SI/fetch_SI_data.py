...
# 執行腳本：抓取 SI (白銀期貨) 過去 6 個月的 1小時 K線
if __name__ == '__main__':
    fetch_massive_historical_data(symbol='SI', total_months=6, bar_size='1 hour')
